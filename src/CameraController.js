...
const CameraController = () => {
    ...
    const initThree = () => {
        ...
        const Init = () => {
            ...
            let earthMaterialMapTexture = new TextureLoader().load('earthmap1k.jpg')
            let earthMaterialBumpTexture = new TextureLoader().load('earthbump1k.jpg')
            ...
            let cloudMapTexture = new TextureLoader().load('earthCloud.png')
            // cloud metarial
